...
parent_path = 'photos/cellule/2019_03_21 manip 5/f8' # Beaucoup de cellules
...
cv2.imwrite(pathsave+"1_initial_image.png", img)
...
plt.imsave(pathsave+"2_shades_of_gray.png", gray, cmap="gray")
...
plt.imsave(pathsave+"3_threshold.png", thresh, cmap ="gray")
...
plt.imsave(pathsave+"4_distance_transform.png", dist_transform, cmap = "gray")
...
plt.imsave(pathsave+"5_watershed.png", labels, cmap = "jet")
...
plt.imsave(pathsave+"6_patches.png", grands_labels, cmap = "jet")
